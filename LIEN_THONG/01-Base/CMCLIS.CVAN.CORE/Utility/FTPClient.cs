...
namespace CMCLIS.CVAN.CORE
{
    public class FTPClient
    {
        ...
        public static bool CreateFolder(string ftpServerUri, string ftpUserID, string ftpPassword, string folderName)
        {
            try
            {
                if (!FtpDirectoryExists(ftpServerUri, ftpUserID, ftpPassword, folderName))
                {
                    FtpWebRequest request = (FtpWebRequest)FtpWebRequest.Create(ftpServerUri + "/" + folderName);
        ...
        public static bool Upload(string ftpServerUri, string ftpUserID, string ftpPassword, string contentFile, string fileName)
        {
        ...
        /// </summary>
        /// <param name="filename">file full name to be uploaded</param>
        public static bool Upload(string ftpServerUri, string ftpUserID, string ftpPassword, string pathFile)
        {
        ...
        public static bool Download(string ftpServerUri, string ftpUserID, string ftpPassword, string filePath, string fileName)
        {
            ...
            try
            {
                ...
                using (FileStream outputStream = new FileStream(filePath + "\\" + fileName, FileMode.OpenOrCreate, FileAccess.ReadWrite))
                {
