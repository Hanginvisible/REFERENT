...
namespace CMCLIS.CVAN.DATA.OBJECTS
{
    ...
    public class CVAN_MSGIDao : OracleBaseImpl<CVAN_MSGIInfo>
    {
        ...
        public List<CVAN_MSGIInfo> CVAN_MSGI_GetAllWithPadding(string _CVAN_CODE,string _CVAN_MSGO_CODE,string _CVAN_MSG_TYPE_CODE,string _CVAN_STATUS_CODE,int pageIndex, int pageSize,ref int totalRecord)
        {
		 ...
		 public List<CVAN_MSGIInfo> CVAN_MSGI_GetListByLucene(string keyword, int selectTop)
        {
            try
            {
                string[] fieldSelect = {"ID","CVAN_CODE","CVAN_MSGO_CODE","CVAN_MSG_TYPE_CODE","CVAN_MSG_TYPE_NAME","CVAN_CONTENT_XML","CVAN_STATUS_CODE","CVAN_STATUS_NAME","CDATE","LDATE","CUSER","LUSER"};
		...
		#region Using Solr
		 ...
		 public List<CVAN_MSGIInfo> CVAN_MSGI_QuerySolr_GetAllWithPadding(string keyword, string _CVAN_CODE,string _CVAN_MSGO_CODE,string _CVAN_MSG_TYPE_CODE,string _CVAN_STATUS_CODE, int pageIndex, int pageSize,ref int totalRecord)
		 {
		     try
		     {
		         List<ISolrQuery> lstFilter = new List<ISolrQuery>();
