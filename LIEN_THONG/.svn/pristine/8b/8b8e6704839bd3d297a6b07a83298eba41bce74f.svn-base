...
namespace CMCLIS.CVAN.DATA.OBJECTS
{
    ...
    public class CVAN_MSGODao : OracleBaseImpl<CVAN_MSGOInfo>
    {
        ...
        public List<CVAN_MSGOInfo> CVAN_MSGO_GetAllWithPadding(string _CVAN_CODE,string _CVAN_MSG_TYPE_CODE,string _CVAN_SENDER_CODE,int _CVAN_STATUS_SEND,int pageIndex, int pageSize,ref int totalRecord)
        {
		...
		public List<CVAN_MSGOInfo> CVAN_MSGO_GetListByLucene(string keyword, int selectTop)
        {
            try
            {
                string[] fieldSelect = {"ID","CVAN_CODE","CVAN_MSG_TYPE_CODE","CVAN_MSG_TYPE_NAME","CVAN_CONTENT_XML","CVAN_SENDER_CODE","CVAN_STATUS_SEND","CDATE","LDATE","CUSER","LUSER"};
		...
		#region Using Solr
		 ...
		 public List<CVAN_MSGOInfo> CVAN_MSGO_QuerySolr_GetAllWithPadding(string keyword, string _CVAN_CODE,string _CVAN_MSG_TYPE_CODE,string _CVAN_SENDER_CODE,int _CVAN_STATUS_SEND, int pageIndex, int pageSize,ref int totalRecord)
		 {
		     try
		     {
		         List<ISolrQuery> lstFilter = new List<ISolrQuery>();
