...
using CMCLIS.CVAN.WServiceMQD;
using CMCLIS.CVAN.WServiceMQDB.Properties;
...
namespace CMCLIS.CVAN.WServiceMQDB
{
        ...
        static void Main(string[] args)
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                consumer.Received += (model, ea) =>
                {
                    ...
                    //CMCLIS.CVAN.DataObjects.DataObjectFactory.GetInstanceCVAN_MSGO().CVAN_MSGI_INSERT_MSGXML_2_MSGOUT(ea.Exchange, ea.Body, ConfigurationManager.AppSettings["MQ_NAME"]);
                ...
                //System.Resources.ResourceManager rm = CMCLIS.CVAN.WServiceMQDB.Properties.Resources.ResourceManager;
