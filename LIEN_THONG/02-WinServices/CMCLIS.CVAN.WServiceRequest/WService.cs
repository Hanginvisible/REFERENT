...
namespace CMCLIS.CVAN.WServiceRequest
{
    public partial class WService : ServiceBase
    {
        ...
        private void Test()
        {
            ...
            List<CVAN_MSGOInfo> listData = DataObjectFactory.GetInstanceCVAN_MSGO().CVAN_MSGO_GetAllWithPadding(string.Empty, string.Empty, string.Empty, 0, 1, pageSize, ref totalRecord);
            //lock data
