...
namespace CMCLIS.GATEWAY.GATEWAY.Controllers
{
    [EnableCors("*", "*", "*")]
    public class WebApiController : ApiController
    {
        ...
        public ResponseList<CVAN_MSGIInfo> Service_Load_MSGI(string cvancode, string msgocode, string msgtypecode, string statuscode)
        {
            try
            {
                ...
                List<CVAN_MSGIInfo> MSGIInfos = DataObjectFactory.GetInstanceCVAN_MSGI().CVAN_MSGI_QuerySolr_GetAllWithPadding(string.Empty, cvancode, msgocode, msgtypecode, statuscode,0, 1, int.MaxValue, ref totalCount);
        ...
        public ResponseList<CVAN_MSGOInfo> Service_Load_MSGO(string cvancode, string msgtypecode, string sendercode, int statussend)
        {
            try
            {
                ...
                List<CVAN_MSGOInfo> MSGOInfos = DataObjectFactory.GetInstanceCVAN_MSGO().CVAN_MSGO_QuerySolr_GetAllWithPadding(string.Empty, cvancode, msgtypecode, sendercode, statussend, 0,1, int.MaxValue, ref totalCount);
        ...
        public ResponseList<CVAN_MAILInfo> Service_Load_MAIL(string cvanfrom, string cvanto, string cvansubject, string cvantypecode, int cvanstatus)
        {
            try
            {
                ...
                List<CVAN_MAILInfo> mails = DataObjectFactory.GetInstanceCVAN_MAIL().CVAN_MAIL_QuerySolr_GetAllWithPadding(string.Empty,cvanfrom, cvanto, cvansubject, cvantypecode, cvanstatus,0, 1, int.MaxValue, ref totalCount);
