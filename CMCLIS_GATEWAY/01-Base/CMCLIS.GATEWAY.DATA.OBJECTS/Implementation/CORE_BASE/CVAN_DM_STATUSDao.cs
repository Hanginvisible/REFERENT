...
namespace CMCLIS.GATEWAY.DATA.OBJECTS
{
    ...
    public class CVAN_DM_STATUSDao : OracleBaseImpl<CVAN_DM_STATUSInfo>
    {
        ...
        public List<CVAN_DM_STATUSInfo> CVAN_DM_STATUS_GetAllWithPadding(string _CVAN_CODE,string _CVAN_NAME,int _CVAN_STATUS,int _IS_DELETE,int pageIndex, int pageSize,ref int totalRecord)
        {
		 ...
		 public List<CVAN_DM_STATUSInfo> CVAN_DM_STATUS_GetListByLucene(string keyword, int selectTop)
        {
            try
            {
                string[] fieldSelect = {"ID","CVAN_CODE","CVAN_NAME","CVAN_DESCRIPTION","CVAN_STATUS","CVAN_PARENT","CVAN_PARENT_NAME","IS_DELETE","CDATE","LDATE","CUSER","LUSER"};
		...
		#region Using Solr
		 ...
		 public List<CVAN_DM_STATUSInfo> CVAN_DM_STATUS_QuerySolr_GetAllWithPadding(string keyword, string _CVAN_CODE,string _CVAN_NAME,int _CVAN_STATUS,int _IS_DELETE, int pageIndex, int pageSize,ref int totalRecord)
		 {
		     try
		     {
		         List<ISolrQuery> lstFilter = new List<ISolrQuery>();
