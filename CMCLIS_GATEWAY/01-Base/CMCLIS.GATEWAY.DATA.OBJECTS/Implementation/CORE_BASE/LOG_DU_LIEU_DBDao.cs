...
namespace CMCLIS.GATEWAY.DATA.OBJECTS
{
    ...
    public class LOG_DU_LIEU_DBDao : OracleBaseImpl<LOG_DU_LIEU_DBInfo>
    {
        ...
        public List<LOG_DU_LIEU_DBInfo> LOG_DU_LIEU_DB_GetAllWithPadding(string _USER_NAME,string _TABLE_NAME,string _ACTION,int _IS_DELETE,DateTime _CDATE_START_DATE,DateTime _CDATE_END_DATE,int pageIndex, int pageSize,ref int totalRecord)
        {
		 ...
		 public List<LOG_DU_LIEU_DBInfo> LOG_DU_LIEU_DB_GetListByLucene(string keyword, int selectTop)
        {
            try
            {
                string[] fieldSelect = {"ID","USER_NAME","TABLE_NAME","ACTION","OLD_VALUE","NEW_VALUE","IS_DELETE","CDATE","LDATE","CUSER","LUSER"};
		...
		#region Using Solr
		 ...
		 public List<LOG_DU_LIEU_DBInfo> LOG_DU_LIEU_DB_QuerySolr_GetAllWithPadding(string keyword, string _USER_NAME,string _TABLE_NAME,string _ACTION,int _IS_DELETE,DateTime? _CDATE_START_DATE,DateTime? _CDATE_END_DATE, int pageIndex, int pageSize,ref int totalRecord)
		 {
		     try
		     {
		         List<ISolrQuery> lstFilter = new List<ISolrQuery>();
