    ...
    public sealed class Config
    {
        ...
        public static string CMCSOFT_MAIL
        {
            get
            {
                ...
                {
                    _CMCSOFT_MAIL = ConfigurationManager.AppSettings[Constant.CMCSOFT_MAIL];
                }
        ...
        private static string _CLIS_MAIL_INFO;
        public static string CLIS_MAIL_INFO
        {
            get
            {
                if (string.IsNullOrEmpty(_CLIS_MAIL_INFO))
                {
                    _CLIS_MAIL_INFO = ConfigurationManager.AppSettings[Constant.CLIS_MAIL_INFO];
                }
                return _CLIS_MAIL_INFO;
            }
        }

        private static string _CMCLIS_LOG_INFO;
        public static string CMCLIS_LOG_INFO
        {
            get
            {
                if(string.IsNullOrEmpty(_CMCLIS_LOG_INFO))
                {
                    _CMCLIS_LOG_INFO = ConfigurationManager.AppSettings[Constant.CMCLIS_LOG_INFO];
                }
                return _CMCLIS_LOG_INFO;
            }
        }
