...
namespace TEST_APP
{
    public partial class Form1 : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            ResponseInfo<ResponseFileInfo> response = HttpWebRequestBase.GET<ResponseInfo<ResponseFileInfo>>("http://localhost:38241/REST/API_FILE_SERVER/FILE_SERVER_DATA/a69a84eb-c596-4a2a-9b50-ada505a89c47");
            var a = response;
        }
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            ...
            byte[] datacontent = File.ReadAllBytes(path);
            string content64 = Convert.ToBase64String(datacontent);
            var a = 1;
            //int totalRecord = 0;
            //int pageSize = 0;
        ...
        {
            CMCLIS.GATEWAY.WServiceMQMail.CommonFunction.ConsumeQueue();
        }
    }
}
